...
export const ManagePublishedBlogsCard = ( { blog }) => {
  ...
  return (
   ...
   <div className='flex gap-10 border-b mb-6 max-md:px-4 border-grey pb-6 items-center'>
    ...
    <img src={banner} alt='error' className="max-md:hidden lg:hidden xl:block w-28 h-28 flex-none bg-grey object-cover " />
    ...
    <div className="flex flex-col justify-between py-2 w-full min-w-[300px]">
        ...
        <div className="flex gap-6 mt-3 ">
            <Link to={`/editor/${blog_id}`} className="py-2 underline pr-4">Edit</Link>

            <button onClick={() => setShowStat(prevVal => !prevVal)} className="lg:hidden pr-4 py-2 underline">Stats</button>
...
const deleteBlog = ( blog, access_token, target) =>{
    ...
    axios.post(import.meta.env.VITE_DOMAIN_SERVER  + "/delete-blog",{blog_id},{headers :{
