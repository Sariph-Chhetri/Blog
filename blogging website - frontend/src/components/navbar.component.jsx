...
const Navbar = () => {
  ...
  return (
    ...
    <nav className='navbar'>
      ...
      md:inset-0 md:p-0 md:w-auto md:show ${searchBoxVisibility ? "show" : "hide"}`}>
       <input 
       type="text"
       placeholder='Search'
...
<div className='flex items-center gap-3 md:gap-6 ml-auto'>
 ...
 <button className='md:hidden bg-grey w-12 h-12 rounded-full flex 
...
<Link to='/signup' className='hidden md:block btn-light py-2'>Sign Up</Link>
