...
const publishBlog = (e) => {
  ...
  if (!des.length || des.length > characterLimit) {
      return toast.error(`Write description about your blog within ${characterLimit} characters`);
  }
  ...
  let blogObj = {
      ...
      tags,
      des,
      content, // Ensure this is properly structured
      draft: false
  };
  ...
  .catch(({ response }) => {
      ...
      return toast.error(response?.data?.error || "An unexpected error occurred");
  });
};
